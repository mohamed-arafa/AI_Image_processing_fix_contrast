# This program is written to Fix a Low-Contrast Gray-Scale Image using Histogram Equalization in Python 
...
def Histogram_Equalization(Image, Min, Max):
	...
	return New_Image
def main():
	Input_Image = cv.imread("Low_Contrast.png",0) # This is to read Gray Scale Image
	...
	cv.imwrite("Fixed_Low_Contrast1.png", New_Image)
